...
__export(index_exports, {
  ...
  __setPreferredRecognition: () => __setPreferredRecognition,
  apply: () => apply,
  en: () => en,
  inject: () => inject,
  zh: () => zh
...
var STOP_WATCHDOG_MS = 2500;
var START_WATCHDOG_MS = 1e4;
...
var BRIDGE_HOST = "http://127.0.0.1:8765";
function createWindowsEngineBridge({
  baseUrl = BRIDGE_HOST,
...
// src/windows-recognition.js
var WindowsBridgeRecognition = class {
...
function createWindowsRecognition(options) {
...
var preferredRecognitionFactory = null;
function __setPreferredRecognition(factory) {
