...
__export(index_exports, {
  DEFAULT_SILENCE_TIMEOUT_MS: () => DEFAULT_SILENCE_TIMEOUT_MS,
  SILENCE_NOTICE_MS: () => SILENCE_NOTICE_MS,
  SpeechInputButton: () => SpeechInputButton,
  VOICE_ACTIVITY_THRESHOLD: () => VOICE_ACTIVITY_THRESHOLD,
  apply: () => apply,
  en: () => en,
  inject: () => inject,
  zh: () => zh
...
// src/client/index.js
var NS = "speech-input";
var WAVEFORM_SEGMENTS = 16;
var DEFAULT_SILENCE_TIMEOUT_MS = 5e3;
var SILENCE_NOTICE_MS = 2600;
var VOICE_ACTIVITY_THRESHOLD = 0.04;
...
function StopIcon() {
  ...
  return import_react.default.createElement("svg", {
    ...
    viewBox: "0 0 24 24",
    width: 26
  }, ...bars.map((bar) => import_react.default.createElement("path", {
...
function SpeechInputButton({
  ...
  const [silenceNotice, setSilenceNotice] = import_react.default.useState(false);
  ...
  const clearNoticeTimer = import_react.default.useCallback(() => {
    if (noticeTimer.current === null) return;
    clearTimeout(noticeTimer.current);
    noticeTimer.current = null;
  }, []);
  const handleState = import_react.default.useCallback((state) => {
    setVoice(state);
